<template>
  <div class="top-right-btn" :style="style">
    <el-row>
      ...
      <el-tooltip v-if="Object.keys(columns).length > 0" class="item" effect="dark" content="显隐列" placement="top">
    ...
    <el-dialog v-model="open" :title="title" append-to-body>
      <el-transfer v-model="value" :titles="['显示', '隐藏']" :data="transferData" @change="dataChange"></el-transfer>
    </el-dialog>
  </div>
</template>
